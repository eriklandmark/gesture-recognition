...
train_generator = generators.DataGeneratorV2(data_ids, labels, **{'batch_size': BATCH_SIZE, "usable_frames": 16})
eval_generator = generators.DataGeneratorV2(eval_ids, labels, **{'batch_size': BATCH_SIZE, "usable_frames": 16})
